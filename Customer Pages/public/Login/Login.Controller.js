...
var loginController = /** @class */ (function () {
    function loginController(loginService) {
        ...
        this.createCustomer = function (req, res) { return __awaiter(_this, void 0, void 0, function () {
        ...
        this.createServiceProvider = function (req, res) { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.loginService
        ...
        this.login = function (req, res) { return __awaiter(_this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                return [2 /*return*/, this.loginService.getUserByEmail(req.body.Email).then(function (user) {
                        if (!user) {
                            return res.status(404).json('Sign Up first');
                        }
                        else {
                            bcryptjs_1.default.compare(req.body.Password, user.Password).then(function (doMatch) { return __awaiter(_this, void 0, void 0, function () {
                                var token_1;
                                return __generator(this, function (_a) {
                                    if (doMatch) {
                                        token_1 = this.loginService.generateToken(user.Email);
                                        return [2 /*return*/, this.loginService.getUserByEmail(req.body.Email).then(function (user) {
                                                if ((user === null || user === void 0 ? void 0 : user.RoleId) == '3') {
                                                    return res.status(200).cookie("token", token_1, { httpOnly: true, expires: new Date(Date.now() + 600000) }).json({
                                        ...
                                        return [2 /*return*/, res.status(404).json('Invalid Password')];
                                    }
                                    return [2 /*return*/];
                                });
                            }); }).catch(function (error) {
        ...
        this.validateToken = function (req, res, next) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                jwt.verify(token, process.env.SECRET_KEY, function (error, decodedToken) {
                    if (error) {
