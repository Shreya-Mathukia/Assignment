...
var ScheduleService = /** @class */ (function () {
    ...
    ScheduleService.prototype.generateToken = function (Email, Zipcode, ServiceRequestId) {
        var emailToken = jsonwebtoken_1.default.sign({ Email: Email, Zipcode: Zipcode, ServiceRequestId: ServiceRequestId }, process.env.SECRET_KEY, { expiresIn: '6h' });
        return emailToken;
    };
