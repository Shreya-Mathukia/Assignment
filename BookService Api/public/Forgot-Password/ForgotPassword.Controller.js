    ...
    function ForgotPasswordController(ForgotPasswordService) {
        ...
        this.ForgotPassword = function (req, res) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                return [2 /*return*/, this.ForgotPasswordService.getUserByEmail(req.body.Email).then(function (user) {
                        if (user === null) {
                            return res.status(500).json("Invalid mail, Try agian or creating an account first.");
                        }
                        else {
                            return _this.ForgotPasswordService.sendResetMail(req.body.Email).then(function (a) {
                                if (true) {
                                    return res.status(200).cookie("userEmail", req.body.Email).json("Check your mail");
                                }
        ...
        this.ResetPassword = function (req, res) { return __awaiter(_this, void 0, void 0, function () {
            var Password, Mail, Email, userEmail;
            var _this = this;
            var _a;
            return __generator(this, function (_b) {
                Password = req.body.Password;
                Mail = (_a = req.headers.cookie) === null || _a === void 0 ? void 0 : _a.split("=");
                Email = String(Mail[1]);
                ...
                bcryptjs_1.default.hash(Password, 10, function (err, hash) {
                    if (err) {
                        ...
                        return _this.ForgotPasswordService.UpdateUser(hash, userEmail).then(function (user) {
                            if (user)
